	$(function(){
			...
			$('#loading-file-a').on('click', function(){//event
			...
			//2ème appel 
			$('#loading-file-b').on('click', function(){//event
			...
			//3ème appel 
			$('#loading-file-base').on('click', function(){//event
      ...
      //4ème appel
      $('#loading-file-c').on('click', function(){//event
